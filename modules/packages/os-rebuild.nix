  ...
  perSystem =
    ...
    let
      ...
      same-system-oses =
        let
          has-same-system =
            _n: o: o.config.nixpkgs.hostPlatform.system == pkgs.stdenvNoCC.hostPlatform.system;
      ...
      os-builder =
        ...
        let
          ...
          darwin-rebuild = lib.getExe inputs.darwin.packages.${platform.system}.darwin-rebuild;
        ...
        text = ''
          export PATH="${
            pkgs.lib.makeBinPath (
              ...
              ++ (lib.optionals pkgs.stdenv.isLinux [ pkgs.stdenvNoCC.hostPlatform.systemd ])
          ...
          if [ "-h" = "''${1:-}" ] || [ "--help" = "''${1:-}" ]; then
            ...
            echo
            echo Known hostnames on ${pkgs.stdenvNoCC.hostPlatform.system}:
